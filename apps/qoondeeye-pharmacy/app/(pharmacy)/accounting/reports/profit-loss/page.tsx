...
export default function ProfitLossReportPage() {
  ...
  const [varianceDrivers, setVarianceDrivers] =
  ...
  const load = React.useCallback(async () => {
    ...
    try {
      ...
      setData(res);
      setVarianceDrivers(driverRes.rows?.[0] ?? null);
    } catch (e: unknown) {
      setErr(e instanceof Error ? e.message : "Failed to load profit and loss");
      setData(null);
      setVarianceDrivers(null);
    } finally {
      setLoading(false);
    }
  }, [
